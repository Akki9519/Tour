...
import logo from './../../assets/images/guide.png'
    ...
    const handlesubmit = () => {
        ...
        if (name && email && password && address) {
            ...
            if (!checked) {
                ...
                const config = { method: 'post', url: 'http://localhost:3000/register', headers: { 'Content-Type': 'application/json'},data: data };
                ...
                <div className="flex flex-col p-1 m-3 bg-white rounded-lg shadow text-left border-blue-600 border-b-4 border-t-4">
                    ...
                    <div className="grid grid-cols-1">
                        <div className="flex flex-row mt-2 ml-4">
                            ...
                            <Link to='/login'><div className="text-[#0369a8] pl-1 ml-5 underline cursor-pointer flex-grow">Sign In</div></Link>
                        </div>
